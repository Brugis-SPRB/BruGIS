...
app.mount("/", function(request) {
    ...
    var target = request.scheme + "://" + request.host + ":" + request.port + request.scriptName + "/brugis/";
    return {
        status: 303,
...
app.mount("/brugis", require("./root/brugis").app);
...
app.mount("/brugis/proxy", require("./root/proxy").app);
