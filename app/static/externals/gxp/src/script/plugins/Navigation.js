...
gxp.plugins.Navigation = Ext.extend(gxp.plugins.Tool, {
    ...
    addActions: function() {
        ...
        var actions = [new GeoExt.Action({
            ...
            enableToggle: true,
            pressed: false,		// DOCG to be sure this is not pressed at the beginning, does not seem to work though
            allowDepress: true,	// DOCG to be sure this can be de-pressed by the user
