...
GeoExt.Lang.add("fr", {
	...
	"ux.plugins.Preferences.prototype" : {
		...
		searchResultText: 				"Résultat de recherche",
		multipleSearchText: 			"Multiple",
		uniqueSearchText: 				"Unique",
		toolsVisibilityOptionLabelText:			"Outils: options d'affichage",
		showQueryToolLabelText: 				"Outil de recherche",
		showGeolocatorToolLabelText: 			"Outil de geolocalisation",
		showUrbanalysisToolLabelText: 			"Outils d'urbanalyse",
		showDataEditorToolslabelText: 			"Outils d'édition",
	...
	"ux.plugins.ReperageToolbox.prototype" : {
		...
		reperageAdrTextfieldLabel: "Adresse",
		...
		myReperageGridPanel_adress_header: "Adresse",
	...
	"ux.plugins.MyMaps.prototype": {
		...
		exportButtonTooltipText: "Lien temporaire vers la carte",
