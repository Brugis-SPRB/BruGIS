 ...
 */
ux.plugins.WMSLegend = Ext.extend(GeoExt.LayerLegend, {
    ...
    initComponent: function() {
        ux.plugins.WMSLegend.superclass.initComponent.call(this);
    ...
    update: function() {
        ...
        ux.plugins.WMSLegend.superclass.update.apply(this, arguments);
    ...
    beforeDestroy: function() {
        ...
        ux.plugins.WMSLegend.superclass.beforeDestroy.apply(this, arguments);
    }
 ...
 *  Private override
 */
ux.plugins.WMSLegend.supports = function(layerRecord) {
    return layerRecord.getLayer() instanceof OpenLayers.Layer.WMS ? 1 : 0;
};

/** api: legendtype = gx_wmslegend */
GeoExt.LayerLegend.types["ux_wmslegend"] = ux.plugins.WMSLegend;

/** api: xtype = ux_wmslegend */
Ext.reg('ux_wmslegend', GeoExt.WMSLegend);
